    ...
    <section id="projects" className="py-14 sm:py-20 bg-gradient-secondary" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base xs:text-lg text-muted-foreground max-w-xs xs:max-w-md sm:max-w-3xl mx-auto mb-8">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              {allTechnologies.map((tech) => (
                <Button
                  ...
                  className={`transition-all duration-300 ${selectedTech === tech
